function [T11rz, T12rz, T21rz, T11dz, T12dz, T21dz]=f_CoprFac_hsvio(P_ss,F,L,weights) % W1, W2, W3, Wd1, Wd2, Wd3, W1c, W2c, W3c, Wd1c, Wd2c, Wd3c)
...
s=tf('s');
T11rz2=series(W2*KSOut11,ss(1/s)); T12rz2=series(W2*KSOut12,ss(1/s)); T21rz2=KSOut21;
T11dz2=series(Wd2*SInP11,ss(s)); T12dz2=series(Wd2*SInP12,ss(s)); T21dz2=SInP21;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
